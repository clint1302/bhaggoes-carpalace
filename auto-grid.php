	             ...
	             <div class="cs-listing-filters">
								...
								<div class="inventory-model-box">
												...
												<div class="inventory-model-items">
																...
																<div class="checkbox carmodel-item">
																	<label><input class="chk-carbrand" type="checkbox" brand-id="<?php echo $f_cbrands['brand_id']; ?>" value="<?php echo $f_cbrands['title']; ?>"><?php echo $f_cbrands['title']; ?></label>
									...
									<!-- Select Model -->
									<div class="inventory-model-box" id="carmodel-box" >
                       <div class="inventory-model-title"><h6>Select Model</h6></div>
											 ...
											 <div class="inventory-model-items">
													...
													$f_fbrand= mysqli_fetch_assoc($con->query("SELECT * FROM `car_brands` WHERE `brand_id` = '".$f_cmodels['brand_id']."'"));

													$count_car_model = mysqli_num_rows($con->query("SELECT `car_id` FROM `cars` WHERE `model_id` = '".$f_cmodels['model_id']."' AND `status` > 0 "));
													
													?>
															<div class="checkbox carmodel-item carmodel-spec" brandTitle="<?php echo $f_fbrand['title']; ?>" style="display:none;">
																<label><input class="chk-carmodel" type="checkbox"  value="<?php echo $f_cmodels['model_id']; ?>"><?php echo $f_fbrand['title']; ?> - <?php echo $f_cmodels['title']; ?></label>
									...
									<!-- Select Year --><div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				      ...
				      <div class="panel-body">
				        <div class="cs-model-year">
				          <div class="cs-select-filed">
                           <select data-placeholder="Recent Added" class="chosen-select-no-single" id="b-modelyear" tabindex="5">
				          ...
				          <span>to</span>
				          <div class="cs-select-filed">
				            <select data-placeholder="Recent Added" class="chosen-select-no-single" id="e-modelyear" tabindex="5">
													<option disabled selected value>year</option>	
														<?php 
															for($i = 2000 ; $i <= date('Y'); $i++){
																	echo "<option yearid=".$i.">$i</option>";
					...
					<!-- Select Year -->
									 ...
									 <input type="text" placeholder="Insert Keyword" id="carkeyword" class="search-keyword">
									 <div class="search-button" id="search-car">Search</div>
									 <!--<button class="search-button" id="search-test">Search</button>
	               <div class="cs-search">
...
if (window.history && window.history.pushState) {
	...
	//window.history.pushState('forward', null, './auto-grid.php');
...
$("#search-car").unbind("click").click(function(event){
	...
	beginModelYear = $('#b-modelyear').find(":selected").text();
	endModelYear = $('#e-modelyear').find(":selected").text();
	            ...
	            <div class="row cars-main-section">
	              ...
	              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php
						...
						$result = mysqli_query($con, "SELECT * FROM `cars` WHERE `status` > 0 AND `pre_owned` < 1 LIMIT $start, $perpage");
	                ...
	                <nav>
		                <ul class="pagination">
											...
											<?php
														...
														$result = mysqli_query($con,"SELECT COUNT(*) AS Total FROM `cars` WHERE `status` > 0 AND `pre_owned` < 1 ");
