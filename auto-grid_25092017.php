											 ...
											 <div class="inventory-model-items">
													...
													?>
															<div class="checkbox carmodel-item">
																<label><input class="check-carmodel" type="checkbox" value="<?php echo $f_cmodels['model_id']; ?>"><?php echo $f_cmodels['title']; ?></label>
																<span>(<?php echo $count_car_model ?>)</span>
															</div>
															<?php
															}
...
// Get car model
$('input:checkbox[class=check-carmodel]').each(function(){    
		if($(this).is(':checked'))
		carmodel = $(this).val();
...
//checkbox car model
$('input.check-carmodel').on('change', function() {
    $('input.check-carmodel').not(this).prop('checked', false);  
});
				...
				?>
	              ...
	              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                <div class="auto-listing auto-grid">
	                  <div class="cs-media">
	                     <figure> <img src="<?php echo BASEHREF."cms/upload/cars/medium/".$f_cars['img']; ?>" alt="#"/></figure>
	                  </div>
	                  <div class="auto-text">
										<span class="cs-categories">Bhaggoes</span>
															<div class="post-title">
														<h4><a href="#"><?php echo $f_model['title'];?> - <?php echo $f_cars['year'];?></a></h4>
