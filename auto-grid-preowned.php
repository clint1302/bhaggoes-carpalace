	                ...
	                <nav>
		                <ul class="pagination">
											...
											<?php
														...
														echo "<li><a href='auto-grid-preowned.php?page=$j' aria-label='Previous'><span aria-hidden='true'><i class='icon-angle-left'></i></span></a></li>";
														...
														echo "<li><a href='auto-grid-preowned.php?page=$i'>$i</a></li>";
														...
														echo "<li><a href='auto-grid-preowned.php?page=$j' aria-label='Next'><span aria-hidden='true'><i class='icon-angle-right'></i></span></a></li>";
